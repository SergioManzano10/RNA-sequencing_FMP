...
* We created a nextflow.config file, located in the BASH scripts folder under the name ![nextflow_rnaseq.config](BASH/nextflow_rnaseq.config)*nextflow_rnaseq.config*. This file contains the Nextflow requirements for job distribution and resource allocation.
